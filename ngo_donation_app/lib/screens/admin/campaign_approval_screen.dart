...
class CampaignApprovalScreen extends StatefulWidget {
  ...
  @override
  State<CampaignApprovalScreen> createState() =>
      _CampaignApprovalScreenState();
}

class _CampaignApprovalScreenState
    extends State<CampaignApprovalScreen> {
  ...
  Widget _buildCampaignCard(
      Map<String, dynamic> campaign, int index) {
    final categoryColor =
